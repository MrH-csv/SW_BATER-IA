...
#ifndef INA226_V1_AHNM_H_
#define INA226_V1_AHNM_H_
...
class INA226_V1
{
    public:
        ...
        INA226_V1(const int addr = 0x40) : _wire{&Wire}, i2cAddress{addr} {}
        INA226_V1(TwoWire *w, const int addr = 0x40) : _wire{w}, i2cAddress{addr} {}
